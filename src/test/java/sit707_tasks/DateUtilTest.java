...
public class DateUtilTest {
	...
	//February
	//This is the Leap Year test for February 2024.
	@Test
	...
	@Test
	public void testMaxFeb29ShouldDecrementToFeb28() {
	...
	@Test
	public void testMinFeb1ShouldIncrementToFeb2() {
		DateUtil date = new DateUtil (1,2,2024);
		System.out.println("Feb1ShouldIncrementToFeb2 >" + date);
		date.increment();
		System.out.println(date);
		Assert.assertEquals(2, date.getDay());
		Assert.assertEquals(2, date.getMonth());
	...
	@Test
	public void testMinFeb1ShouldDecrementToJan31() {
		DateUtil date = new DateUtil (1,2,2024);
		System.out.println("Feb1ShouldDecrementToJan31 >" + date);
		date.decrement();
		System.out.println(date);
		Assert.assertEquals(31, date.getDay());
		Assert.assertEquals(1, date.getMonth());
